<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="10">
          ...
          <a-col v-bind="aColFlex">
            <a-form-item>
              <a-input v-model="queryParam.query.account" placeholder="请输入邮箱" :allowClear="true"  @keyup.enter.native="query"/>
            </a-form-item>
          </a-col>
          <a-col v-bind="aColFlex">
            <a-form-item>
              <a-select v-model="queryParam.query.lang" placeholder="请选择模板语种" :options="$DictList('language_type')" :allowClear="true" @keyup.enter.native="query">
              </a-select>
            </a-form-item>
          </a-col>
          <a-col v-bind="aColFlex">
            <a-form-item>
              <a-select v-model="queryParam.query.status" placeholder="请选择发送状态" :options="$DictList('sms_send_status')" :allowClear="true" @keyup.enter.native="query">
              </a-select>
            </a-form-item>
          </a-col>
          <a-col v-bind="aColFlex">
    ...
    <!-- 表格 -->
    <div class="total">邮件发送记录：{{ pagination.total }}</div>
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { dataIndex: "method", title: "通知类型", scopedSlots: { customRender: "method" } },
        { dataIndex: "lang", title: "模板语种", scopedSlots: { customRender: "lang" } },
        { dataIndex: "account", title: "邮箱" },
  ...
  methods: {
    ...
    queryList() {
      ...
      this.queryParam.query.method = 2
